    ...
    value: function render() {
      ...
      if (canDrag) {
        if (typeof node.children === 'function' && node.expanded) {
          ...
          handle = connectDragSource(React.createElement('div', { className: 'rst__moveHandle' }), {
            dropEffect: 'copy'
          });
        }
      }
      ...
      return React.createElement(
        ...
        toggleChildrenVisibility && node.children && (node.children.length > 0 || typeof node.children === 'function') && React.createElement(
          'div',
          null,
        ...
        React.createElement(
          ...
          connectDragPreview(React.createElement(
            'div',
            {
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                nodeSubtitle && React.createElement(
                  'span',
  ...
  createClass(TreePlaceholder, [{
    ...
    value: function render() {
      ...
      return connectDropTarget(React.createElement(
        ...
        null,
        Children.map(children, function (child) {
          return cloneElement(child, _extends({}, otherProps));
        })
      ));
    }
  }]);
...
var ReactSortableTree = function (_Component) {
  ...
  function ReactSortableTree(props) {
    ...
    if (isVirtualized) {
      _this.scrollZoneVirtualList = withScrolling(List);
